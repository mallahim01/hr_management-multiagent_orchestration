...
check("core.routing_judge",    lambda: __import__("core.routing_judge"))
check("knowledge.chunker",     lambda: __import__("knowledge.chunker"))
check("knowledge.embeddings",  lambda: __import__("knowledge.embeddings"))
check("knowledge.store",       lambda: __import__("knowledge.store"))
check("knowledge package",     lambda: __import__("knowledge"))
